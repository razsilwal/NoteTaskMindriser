...
from base.views import register_view, home, createNote, notetype, create_notetype, edit_note_view, delete_note, delete_all_note, edit_notetype,delete_notetype
